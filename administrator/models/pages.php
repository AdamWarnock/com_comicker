 ...
 */
class ComickerModelPages extends JModelList {
    ...
    public function __construct($config = array()) {
        if (empty($config['filter_fields'])) {
            $config['filter_fields'] = array(
                ...
                'pagenotes', 'a.pagenotes',
                'parentchapter', 'a.parentchapter',
                'pagetranscript', 'a.pagetranscript',
                'pagemouseovertext', 'a.pagemouseovertext',
    ...
    protected function populateState($ordering = null, $direction = null) {
        ...
        parent::populateState('a.pagetitle', 'asc');
    }
    ...
    protected function getListQuery() {
        ...
        $query->from('`#__comicker_pages` AS a');
		...
		$query->select('#__comicker_chapters_1951375.id AS chapters_id_1951375');
		$query->join('LEFT', '#__comicker_chapters AS #__comicker_chapters_1951375 ON #__comicker_chapters_1951375.id = a.parentchapter');
        ...
        if (!empty($search)) {
            if (stripos($search, 'id:') === 0) {
                ...
                $query->where('( a.pagetitle LIKE '.$search.'  OR  a.parentchapter LIKE '.$search.' )');
            }
        }
