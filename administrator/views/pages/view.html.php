 ...
 */
class ComickerViewPages extends JViewLegacy {
    ...
    public function display($tpl = null) {
        ...
        ComickerHelper::addSubmenu('pages');
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('COM_COMICKER_TITLE_PAGES'), 'pages.png');
        ...
        JHtmlSidebar::setAction('index.php?option=com_comicker&view=pages');
        ...
        $form = JForm::getInstance('com_comicker.page', 'page');
	...
	protected function getSortFields()
	{
		...
		'a.created_by' => JText::_('COM_COMICKER_PAGES_CREATED_BY'),
		'a.pagetitle' => JText::_('COM_COMICKER_PAGES_PAGETITLE'),
		'a.parentchapter' => JText::_('COM_COMICKER_PAGES_PARENTCHAPTER'),
		);
	}
